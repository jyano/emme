...
C$.fi =C$.f = function (docs, key, val) {
...
cl.l21=cl.ls1 = cl.l1 = function (a, b, c, d) {
...
function old(){
	...
	Cl$Ul = function (cl) {return new Ul_({collection: cl})
	}
...
$ClView =$CollectionView = function(View, cl){return new View({collection: cl})}
$ClViewEl = function(View, cl){return new View({collection: cl}).R().el}
